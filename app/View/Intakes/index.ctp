<div class="inputs index">
	...
	<tr>
		...
		<td><?php echo h($input['Input']['amount']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $input['Input']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $input['Input']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
