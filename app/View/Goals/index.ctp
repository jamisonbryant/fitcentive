<div class="goals index">
	...
	<tr>
		...
		<td><?php echo h($goal['Goal']['name']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $goal['Goal']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $goal['Goal']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
